  ...
  return (
    <form action={action}>
      <FieldGroup>
        ...
        <Feedback state={{ error: oauthError }} />
        ...
        <GoogleSignIn callbackURL={invitationDestination(next)} mode={mode} />
        {mode === "sign-in" && (
          <Text muted small>
            Already use email and password? Sign in or reset your password, then
